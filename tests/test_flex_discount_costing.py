...
def test_evaluate_list_applies_flex_discount_to_token_cost_only(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("SHOPTECH_FLEX_TOKEN_DISCOUNT", "0.5")
    monkeypatch.setenv("SHOPTECH_PRICE_INPUT_PER_1M", "1.0")
    monkeypatch.setenv("SHOPTECH_PRICE_CACHED_INPUT_PER_1M", "0.0")
    monkeypatch.setenv("SHOPTECH_PRICE_OUTPUT_PER_1M", "0.0")
    monkeypatch.setenv("SHOPTECH_PRICE_WEB_SEARCH_PER_1K", "10.0")
