...
def test_retry_disambiguation_on_low_confidence_aggregates_cost_and_calls(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("SHOPTECH_PRICE_INPUT_PER_1M", "0")
    monkeypatch.setenv("SHOPTECH_PRICE_CACHED_INPUT_PER_1M", "0")
    monkeypatch.setenv("SHOPTECH_PRICE_OUTPUT_PER_1M", "0")
    monkeypatch.setenv("SHOPTECH_PRICE_WEB_SEARCH_PER_1K", "10.0")  # $0.01 per query
