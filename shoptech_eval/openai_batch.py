...
Instructions:
- Use the web search tool to research the target domain itself for direct platform markers and corroborate via reputable sources if needed.
...
def build_irene_batch_lines(
    ...
    *,
    ...
    for idx, row in enumerate(rows, start=1):
        ...
        firma = (row.get("Name") or row.get("Firma") or "").strip().replace(" ", "_")
